...
static int avre;
        ...
        static  int [][]list=new int[500][500];
         ...
         int [][]mx=new int[500][500];
              
         static  int [][]ned=new int[500][500];
         static  int [][]modilist=new int[500][500];
              
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
       

        Bankersalgorithm jj=new Bankersalgorithm();
        int pronumber=jj.processnumber();
        int rnumber=jj.resourcenumber();
        avpro=pronumber;
        avre=rnumber;

          if(pronumber<ps){
          un(pronumber,rnumber);
           available av=new available();
           av.show();
          //exit(0);
        }
          else if(pronumber==ps){
              
               jTextField1.setText("GO>>>");
          }
          else 
            jTextField1.setText("p"+(ps+1));
             ...
             StringTokenizer toke = new StringTokenizer(text2);
             ...
             for(int i=0;i<clm;i++)
             {
                 ...
                 list[ro][i]=Integer.parseInt(tkn); 
             ...
             for(int i=0;i<clm;i++)
             {
                 String tkn1=toke.nextToken();
                 mx[ro][i]=Integer.parseInt(tkn1);                                
             } 
 
      /*       for(int j=0;j<clm;j++)
          {
              System.out.print(" "+list[ro][j]);
          }
             System.out.println("");
                 for(int j=0;j<clm;j++)
          {
              System.out.print(" "+mx[ro][j]);
          }
                 System.out.println("");       */
           ro+=1;
            jTextField2.setText("");
    ...
    void un(int pronumber,int rnumber){
     // System.out.println(""+pronumber);
       // System.out.println(""+rnumber);
    for( int w=0; w<pronumber; w++)
    {
         for(int w1=0;w1<rnumber;w1++ )
         {
             ned[w][w1]=mx[w][w1]-list[w][w1];
            ...
            /*
    for( int w=0; w< pronumber+1; w++)
    {
         for(int w1=0;w1<rnumber;w1++ )
         {
             ned[w][w1]=mx[w][w1]-list[w][w1];
             System.out.print("need "+ned[w][w1]);
         }
         System.out.println("\n");
    }
    ...
    */
    ...
    int sum=0;
    for( int w=0; w< rnumber; w++)
    {
         sum=0;
         for(int w1=0;w1<pronumber+1;w1++ )
         {
            sum+=list[w1][w];
         }
         modilist[0][w]=sum;
 ...
 //    --- print
    ...
    for( int w=0; w< rnumber; w++)
    {
        System.out.println(" "+modilist[0][w]);
    }
